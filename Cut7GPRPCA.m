function [trainedModel, validationRMSE] = Cut7GPRPCA(trainingData, KFolds, Fraction)
...
% Auto-generated by MATLAB on 2018-12-09 01:05:03
...
includedPredictorNames = predictors.Properties.VariableNames([true true false false true false true true true false true]);
predictors = predictors(:,includedPredictorNames);
isCategoricalPredictor = isCategoricalPredictor([true true false false true false true true true false true]);
...
explainedVarianceToKeepAsFraction = Fraction/100;
...
for fold = 1:KFolds
    ...
    % Data transformation: Select subset of the features
    % This code selects the same subset of features as were used in the app.
    includedPredictorNames = trainingPredictors.Properties.VariableNames([true true false false true false true true true false true]);
    trainingPredictors = trainingPredictors(:,includedPredictorNames);
    foldIsCategoricalPredictor = foldIsCategoricalPredictor([true true false false true false true true true false true]);
