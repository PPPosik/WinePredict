function [trainedModel, validationRMSE] = Cut8GPRHOLDOUT(trainingData)
...
% Auto-generated by MATLAB on 2018-12-13 22:53:35
...
featureSelectionFcn = @(x) x(:,includedPredictorNames);
gpPredictFcn = @(x) predict(regressionGP, x);
validationPredictFcn = @(x) gpPredictFcn(featureSelectionFcn(x));
